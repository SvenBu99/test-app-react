  ...
  return (
    <div className="App">
      ...
      <div className={classes.cnt}>
        <button className={classes.btn} onClick={ScrollToTop}>Test</button>
      </div>
      ...
      <Title datenInput='Unsere Etablisments' sizeInput={2} />
      ...
      <Title datenInput='Services und Dinestleistungen' sizeInput={2} />
      ...
      <Title datenInput='Unsere Dienstleister' sizeInput={2} />
